...
function Color(red = 0.0, green = 0.0, blue= 0.0) {
    this.red = red;
    this.green = green;
    this.blue = blue;
}
...
function Color_multiplyScalar(c1, f) {
    var result = new Color(0, 0, 0);
...
function Color_divideFactor(c1, f) {
    var result = new Color(0, 0, 0);
...
function Light(position= null, color= null, intensity= 10.0) {
...
function Vector_multiplyVector(v, w) {
    return new Vector(v.x * w.x, v.y * w.y, v.z * w.z);
}

function Vector_multiplyScalar(v, w) {
...
BaseMaterial.prototype.getColor = function (u, v)  {
    throw "Abstract method";
}

BaseMaterial.prototype.wrapUp = function(t) {
    t = t % 2.0;
    if (t < -1) t += 2.0;
    if (t >= 1) t -= 2.0;
    return t;
...
function Chessboard(colorEven, colorOdd, 
            reflection, 
            transparency, 
            gloss, 
            density= 0.5) {
...
function Plane(position, d, material) {
    (Shape as any).call(this, position, material);
    this.d = d;
}
...
Camera.prototype.getRay = function(vx, vy) {
...
function Background(color= null, ambience= 0.0) {
    this.color = color;
...
Engine.prototype.setPixel = function(x, y, color) {
    var pxW, pxH;
...
Engine.prototype.renderScene = function(scene, canvas) {
    checkNumber = 0;
    /* Get canvas */
    if (canvas) {
...
Engine.prototype.getPixelColor = function(ray, scene) {
...
Engine.prototype.testIntersection = function(ray, scene, exclude)  {
    var hits = 0;
...
Engine.prototype.getReflectionRay = function(P, N, V) {
    var c1 = -N.dot(V);
    var R1 = Vector_add(
...
Engine.prototype.rayTrace = function(info, ray, scene, depth) {
    // Calc ambient
