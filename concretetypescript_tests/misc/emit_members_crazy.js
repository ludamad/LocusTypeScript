...
$$cts$$runtime.brandTypes.GodObject = new $$cts$$runtime.Brand('GodObject');
function makeGodObject() {
    ...
    }$$cts$$runtime.brand($$cts$$runtime.brandTypes.GodObject, godObject);
    var test = godObject.strOrNum2;
    $$cts$$runtime.brand($$cts$$runtime.brandTypes.GodObject, godObject);
    return godObject;
}
$$cts$$runtime.cementGlobal("makeGodObject",makeGodObject);
var go = ($$cts$$runtime.cast($$cts$$runtime.brandTypes.GodObject,(makeGodObject())));
