...
var Foo = function () {
    /*this-branded*/function Foo() {
        ...
        this.x = this.y;$$cts$$runtime.brand($$cts$$runtime.brandTypes.Foo, this);
    }
...
var Bar = function () {
    /*this-branded*/function Bar() {
        ...
        this.total = this.x + this.y + this.z;$$cts$$runtime.brand($$cts$$runtime.brandTypes.Bar, this);
    }
    // Do we error if this assignment does not exist?
    $$cts$$runtime.protectProtoAssignment(Number, undefined, $$cts$$runtime.brandTypes.Bar.prototype, "z", Bar, 1);;
